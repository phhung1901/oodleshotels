...
arrowimages: {down:['downarrowclass', 'image/down.gif', 23], right:['rightarrowclass', 'image/right.gif', '']},
...
buildmenu: function($, setting){
	...
	var orient = setting.orientation!='v'? 'right' : 'down', $parentshadow = $(document.body);
